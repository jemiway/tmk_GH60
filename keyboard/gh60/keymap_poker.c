...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP_ANSI(
        ...
        LSFT,Z,   X,   C,   V,   B,   K,   M,   COMM,DOT, SLSH,     UP,  RSFT, \
        LCTL,LGUI,LALT,          SPC,                     FN0, HOME,PGDN,END),
    /* 2: dvorak */
    KEYMAP_ANSI(
        GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   LBRC,RBRC,BSPC, DEL,\
        TAB, QUOT,COMM,DOT, P,   Y,   F,   G,   C,   R,   L,   SLSH,EQL, BSLS, \
        CAPS,A,   O,   E,   U,   I,   D,   H,   T,   N,   S,   MINS,     ENT,  \
        LSFT,SCLN,Q,   J,   K,   X,   B,   M,   W,   V,   Z,        UP,  RSFT, \
    ...
    KEYMAP_ANSI(
        ...
        LSFT,Z,   X,   M,   C,   V,   K,   L,   COMM,DOT, SLSH,     UP,  RSFT, \
        LCTL,LGUI,LALT,          SPC,                     FN0, RGUI,APP, RCTL),
    /* 4: Poker with Arrow */
    KEYMAP_ANSI(
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     UP,  RSFT, \
    ...
    KEYMAP_ANSI(
        ...
        GRV ,TRNS, UP,  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,CALC,TRNS,HOME,INS, TRNS,  \
        TRNS,LEFT, DOWN,RGHT,TRNS,TRNS,PSCR,SLCK,PAUS,TRNS,TRNS, END,     TRNS, \
        TRNS,DEL,  TRNS,WHOM,MUTE,VOLU,VOLD,TRNS,PGUP,PGDN,DEL,      PGUP,TRNS, \
        TRNS,TRNS, TRNS,          FN1,                     TRNS,HOME,PGDN,END),
    /* 7: Layout selector
     * ,-----------------------------------------------------------.
     * | Lq| Lc| Ld| Lw|   |   |   |   |   |   |   |   |   |       |
     * |-----------------------------------------------------------|
